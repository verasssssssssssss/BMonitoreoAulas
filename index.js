...
const mc = mysql.createConnection({
  host: "b4zsfnvdcqgkeapqt1np-mysql.services.clever-cloud.com",
  user: "uti9yeim3piud1fv",
  password: "Qql8pTEK8aVSsLfHNgKt",
  database: "b4zsfnvdcqgkeapqt1np",
});
mc.connect();
...
app.listen(3306, () => {
  console.log("Express Server - puerto 3306 online");
});
